const questionData = [
  {
    ...
    options:
      [
        "Apostar em corridas de cavalo",
        "Esquiar",
        "Mergulhar",
        "Tentar descobrir como meu despertador funciona",
        "Ir à missa"
      ]
  },
  {
...

  {
    ...
    options:
      [
        "\“É a imaginação que penetra nos mundos invisíveis que nos rodeiam, nos mundos da ciência.\ˮ",
        "\“Se eu não posso trabalhar com você, vou trabalhar no mesmo ambiente que você.\ˮ",
        "\“Você não precisa agradar a todos, precisa agradar o usuário.\ˮ",
        "\“Se eles te colocarem em algum lugar sem nada para fazer, vá dormir - você não sabe quando vai conseguir mais.\ˮ ou \“Tem um bug nesse sistema.\ˮ",
