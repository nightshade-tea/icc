export const questionData = [
  ...
  },
  {
    ...
    options: [
      [
        "\"É a imaginação que penetra nos mundos invisíveis que nos rodeiam, nos mundos da ciência.\"",
        "ada",
      ],
      [
        "\"Se eu não posso trabalhar com você, vou trabalhar no mesmo ambiente que você.\"",
        "annie",
      ],
      [
        "\"Você não precisa agradar a todos, precisa agradar o usuário.\"",
        "brenda",
      ],
      [
